      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row md:justify-between md:items-center gap-8 text-sm text-gray-600">
        <div>
          ...
          <a
            ...
            className="inline-block mt-3 bg-[#ffdd00] text-black font-medium px-3 py-1.5 rounded-full shadow-sm hover:scale-105 transition-transform hover:shadow-[0_0_12px_rgba(255,221,0,0.4)]"
          >
            ☕ Buy us a coffee
          </a>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:gap-12 gap-6">
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link href="/jane/" className="hover:text-blue-600">
                  J.A.N.E.
                </Link>
              </li>
            </ul>
